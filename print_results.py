...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print(f"Correct Not-Dogs: {results_stats_dic['n_correct_notdogs']}")
    ...
    if print_incorrect_dogs:
        print("Incorrect Dog/Not-Dog Classifications:")
        for filename, values in results_dic.items():
            pet_label, classifier_label, match, is_pet_dog, is_classifier_dog = values
            if is_pet_dog != is_classifier_dog:
                print(f"{filename}: Pet Label = {pet_label}, Classifier Label = {classifier_label}")
    ...
    if print_incorrect_breed:
        ...
        for filename, values in results_dic.items():
            pet_label, classifier_label, match, is_pet_dog, is_classifier_dog = values
            if is_pet_dog == 1 and is_classifier_dog == 1 and match == 0:
                print(f"{filename}: Pet Label = {pet_label}, Classifier Label = {classifier_label}")